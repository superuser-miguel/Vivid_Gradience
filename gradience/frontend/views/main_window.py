...
class GradienceMainWindow(Adw.ApplicationWindow):
    ...
    BUILTIN_PRESET_SECTIONS = [
        ...
        ("Arc", ["arc", "arc-darker", "arc-grey", "arc-dark", "arc-gotham",
                 "arc-grey-dark"]),
        ("Matcha", ["matcha-sea", "matcha-azul", "matcha-aliz", "matcha-pueril",
                    "matcha-dark-sea", "matcha-dark-azul", "matcha-dark-aliz",
                    "matcha-dark-pueril"]),
    ...
    def setup_icon_group(self):
        self.icon_group = GradienceIconThemingGroup(self)
